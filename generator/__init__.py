...
class LinearPUFGenerator(PUFGenerator):
    ...
    def simulate_challenges(self, challenges):
        ...
        return .5 - .5 * simulator.eval(1 - 2 * challenges)
...
class XORPUFGenerator(PUFGenerator):
    ...
    def simulate_challenges(self, challenges):
        return np.sum([p.simulate_challenges(challenges) for p in self.linear_pufs], axis=0) % 2
...
def test_arbiter_puf_simulation():
    ...
    r2 = puf.simulate_challenges(challenges)
